 ...
 * - seed 表：react / react/jsx-runtime / react-dom 用真实包；
...
if (!factories.has('dsh-free-model')) {
  console.error('verify-client FAIL: bundle 未注册 "dsh-free-model" 工厂')
  process.exit(1)
}
...
const edges = new Set()
const exports = factories.get('dsh-free-model')(makeRequire(edges))
const mod = exports || {}

const shapeOk = mod.name === 'dsh-free-model' && typeof mod.apply === 'function' && Array.isArray(mod.inject)
if (!shapeOk) {
