...
export type OpRequest =
  | { op: 'models'; platform?: string; refresh?: boolean; sessionId?: string }
  | { op: 'status'; platform?: string; sessionId?: string }
  | { op: 'checkToken'; platform?: string; token?: string; sessionId?: string }
  | { op: 'useModel'; platform?: string; modelId?: string; model?: Partial<FreeModel>; token?: string; setDefault?: boolean; sessionId?: string }
